...
$monkeyList = [
    ...
    1 => new Monkey(
        ...
        operation: fn(int $value): int => $value * 11,
        testValue: 7,
        number: 1
    ),
    2 => new Monkey(
    ...
    3 => new Monkey(
        ...
        operation: fn(int $value): int => $value + 4,
        testValue: 11,
        number: 3
    ),
    4 => new Monkey(
        itemList: [85, 52, 64],
        operation: fn(int $value): int => $value + 8,
        testValue: 17,
        number: 4
    ),
    5 => new Monkey(
        itemList: [57],
        operation: fn(int $value): int => $value + 2,
        testValue: 5,
        number: 5
    ),
    6 => new Monkey(
    ...
    7 => new Monkey(
        ...
        operation: fn(int $value): int => $value + 5,
        testValue: 19,
        number: 7
    ),
];
